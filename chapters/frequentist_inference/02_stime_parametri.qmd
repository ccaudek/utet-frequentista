...
var(x) / 2                # σ²/n: Varianza teorica per n = 2
...
# Parametri teorici
mu <- 1  # Media della popolazione esponenziale(1)
sigma <- 1  # Deviazione standard della popolazione esponenziale(1)
